...
{
    [Flags]
    public enum ControlMovementDirection1
    {
        Horizontal = 0x1,
        Vertical = 0x2,
    ...
    public class SimpleJoystick1 : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
        ...
        public ControlMovementDirection1 JoystickMoveAxis = ControlMovementDirection1.Both;
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if ((JoystickMoveAxis & ControlMovementDirection1.Horizontal) == 0)
            {
                stickAnchoredPosition.x = _intermediateStickPosition.x;
            }
            if ((JoystickMoveAxis & ControlMovementDirection1.Vertical) == 0)
            {
